...
namespace implemented
{
    class Camera
    {
     public:
        ...
        {
            // TODO(student): Translate the camera using the `up` vector.				position += glm::normalize(up) * distance;
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            // the OX axis. Use `distanceToTarget` as translation distance.TranslateForward(distanceToTarget);
